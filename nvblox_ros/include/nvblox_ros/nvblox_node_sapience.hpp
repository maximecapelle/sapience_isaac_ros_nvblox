...
protected:
  ...
  // SAPIENCE ESDF
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr static_esdf_pointcloud_publisher_1;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr static_esdf_pointcloud_publisher_2;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr static_esdf_pointcloud_publisher_3;
  ...
  // DISTANCE SLICE
  rclcpp::Publisher<nvblox_msgs::msg::DistanceMapSlice>::SharedPtr static_map_slice_publisher_1;
  rclcpp::Publisher<nvblox_msgs::msg::DistanceMapSlice>::SharedPtr static_map_slice_publisher_2;
  rclcpp::Publisher<nvblox_msgs::msg::DistanceMapSlice>::SharedPtr static_map_slice_publisher_3;
  ...
  std::shared_ptr<MultiMapper> multi_mapper_1;
  std::shared_ptr<MultiMapper> multi_mapper_2;
  std::shared_ptr<MultiMapper> multi_mapper_3;
  ...
  std::shared_ptr<Mapper> static_mapper_1;
  std::shared_ptr<Mapper> dynamic_mapper_1;
  std::shared_ptr<Mapper> static_mapper_2;
  std::shared_ptr<Mapper> dynamic_mapper_2;
  std::shared_ptr<Mapper> static_mapper_3;
  std::shared_ptr<Mapper> dynamic_mapper_3;
